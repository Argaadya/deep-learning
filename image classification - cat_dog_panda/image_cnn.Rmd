...
The following is the list of required packages to build and evaluate our image classification. You also need to install the `pillow` library in your conda environment to manipulate image data. Just open the terminal in the Rstudio and insert the following code.
